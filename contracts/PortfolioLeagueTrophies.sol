...
/**
 * @title PortfolioLeagueTrophies
 * @notice Soulbound (non-transferable) NFT trophies for Portfolio League achievements
 * @dev Trophies are minted to players for various achievements and cannot be transferred
 */
contract PortfolioLeagueTrophies is ERC721, ERC721URIStorage, Ownable {
    ...
    constructor() ERC721("Portfolio League Trophies", "PLTROPHY") Ownable(msg.sender) {
        ...
        trophyDescriptions[TrophyType.SEASON_CHAMPION] = "Won a full season of Portfolio League";
    ...
    function _generateSVG(uint256 tokenId) internal view returns (string memory) {
        ...
        return string(abi.encodePacked(
            ...
            '<text x="200" y="340" text-anchor="middle" fill="#0052FF" font-family="Arial" font-size="14">Portfolio League</text>',
            '</svg>'
        ));
    }
